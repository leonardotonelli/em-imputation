...
if __name__ == "__main__":
    ...
    results_df = pd.read_csv("simulation_results/simulation_results.csv")
    ...
    create_full_report(results_df, output_folder='visualization_results')
    ...
    #     data_path="simulation_results/datasets",
